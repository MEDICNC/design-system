(function (global, factory) {
    ...
    var isObject$9 = $documentAll.IS_HTMLDDA
        ? function (it) {
    ...
    var ordinaryToPrimitive$1 = function (input, pref) {
        ...
        if (
            ...
            !isObject$8((val = call$a(fn, input)))
        )
            return val;
    ...
    var wellKnownSymbol$d = function (name) {
        if (!hasOwn$7(WellKnownSymbolsStore, name)) {
            WellKnownSymbolsStore[name] =
                NATIVE_SYMBOL && hasOwn$7(Symbol$1, name)
                    ? Symbol$1[name]
    ...
    var createNonEnumerableProperty$4 = DESCRIPTORS$6
    ...
    var CONFIGURABLE =
        EXISTS &&
        (!DESCRIPTORS$5 ||
            (DESCRIPTORS$5 && getDescriptor(FunctionPrototype$2, 'name').configurable));
  ...
  */
                    ...
                    : // @@toStringTag case
                      ...
                      : // builtinTag case
                        ...
                        : // ES3 arguments fallback
                          (result = classofRaw$1(O)) == 'Object' && isCallable$3(O.callee)
                          ? 'Arguments'
                          : result;
          };
    ...
    if (PATCH) {
        patchedExec = function exec(string) {
            ...
            if (sticky) {
                ...
                if (
                    re.lastIndex > 0 &&
                    (!re.multiline || (re.multiline && charAt$3(str, re.lastIndex - 1) !== '\n'))
                ) {
                    source = '(?: ' + source + ')';
                    strCopy = ' ' + strCopy;
                    charsAdded++;
    ...
    fixRegExpWellKnownSymbolLogic$2('search', function (SEARCH, nativeSearch, maybeCallNative) {
        return [
            ...
            function search(regexp) {
                ...
                var searcher = isNullOrUndefined$3(regexp)
                    ? undefined
                    : getMethod$2(regexp, SEARCH);
                return searcher
                    ? call$5(searcher, regexp, O)
                    : new RegExp(regexp)[SEARCH](toString$6(O));
            },
    ...
    var isRegexp = function (it) {
        ...
        return (
            isObject$3(it) &&
            ((isRegExp = it[MATCH$1]) !== undefined ? !!isRegExp : classof$4(it) == 'RegExp')
        );
    };
        ...
        fails$5(function () {
            ...
            ? function assign(target, source) {
                  ...
                  while (argumentsLength > index) {
                      ...
                      while (length > j) {
                          key = keys[j++];
                          if (!DESCRIPTORS$2 || call$4(propertyIsEnumerable, S, key))
                              T[key] = S[key];
                      }
                  }
                  return T;
    ...
    var speciesConstructor$1 = function (O, defaultConstructor) {
        ...
        var S;
        return C === undefined || isNullOrUndefined$2((S = anObject$3(C)[SPECIES$1]))
            ? defaultConstructor
            : aConstructor(S);
    };
        ...
        function (SPLIT, nativeSplit, maybeCallNative) {
            ...
            if (
                    ...
                    while ((match = call$2(regexpExec, separatorCopy, string))) {
                        ...
                        if (lastIndex > lastLastIndex) {
                            ...
                            if (match.length > 1 && match.index < string.length)
                                apply$1($push, output, arraySlice$1(match, 1));
                ...
                internalSplit = function (separator, limit) {
                    return separator === undefined && limit === 0
                        ? []
                        : call$2(nativeSplit, this, separator, limit);
                };
            ...
            return [
                ...
                function split(separator, limit) {
                    ...
                    var splitter = isNullOrUndefined$1(separator)
                        ? undefined
                        : getMethod$1(separator, SPLIT);
                    return splitter
    ...
    var domTokenListPrototype =
        DOMTokenListPrototype$1 === Object.prototype ? undefined : DOMTokenListPrototype$1;
    ...
    var findByParam = function findByParam(data, param, value) {
        ...
        try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                ...
                if (
                    row[param] === value ||
                    (row[param] === ''.concat(+row[param]) && +row[param] === value)
                ) {
                    return row;
                }
                if (row.type === 'optgroup') {
                    ...
                    try {
                        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                            ...
                            if (
                                child[param] === value ||
                                (child[param] === ''.concat(+child[param]) &&
                                    +child[param] === value)
                            ) {
                                return child;
                            }
        ...
        _createClass(MultipleSelect, [
                ...
                value: function initContainer() {
                    ...
                    this.$parent = $$e(
                        '\n      <div class="ms-parent '
                            ...
                            .concat(el.getAttribute('title') || '', '" />\n    '),
                    );

                    // add placeholder to choice button
                    this.options.placeholder =
                        this.options.placeholder || el.getAttribute('placeholder') || '';
                    ...
                    if (!this.options.keepOpen) {
                        ...
                        $$e(document)
                            ...
                            .on(clickEvent, function (e) {
                                if (
                                    $$e(e.target)[0] === _this.$choice[0] ||
                                    $$e(e.target).parents('.ms-choice')[0] === _this.$choice[0]
                                ) {
                                    return;
                                }
                                if (
                                    ($$e(e.target)[0] === _this.$drop[0] ||
                                        ($$e(e.target).parents('.ms-drop')[0] !== _this.$drop[0] &&
                                            e.target !== el)) &&
                                    _this.options.isOpen
                                ) {
                                    _this.close();
                                }
                            });
                ...
                value: function initData() {
                    ...
                    if (this.options.data) {
                        if (Array.isArray(this.options.data)) {
                            ...
                            for (
                                var _i = 0, _Object$entries = Object.entries(this.options.data);
                    ...
                    try {
                        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                            ...
                            if (row.type === 'optgroup') {
                                ...
                                selectedTotal +=
                                    row.selected && !row.disabled && row.visible ? 1 : 0;
                            }
                        }
                    } catch (err) {
                        _iterator.e(err);
                ...
                value: function initListItem(row) {
                    ...
                    return [
                        '\n      <li class="'
                            ...
                            .concat(classes, '" ')
                            .concat(title, ' ')
                            .concat(style, ' tabindex="')
                            .concat(row.disabled ? -1 : 0, '">\n      <label class="')
                            .concat(row.disabled ? 'disabled' : '', '">\n      <input type="')
                            .concat(type, '"\n        value="')
                            .concat(row.value, '"\n        data-key="')
                            .concat(row._key, '"\n        ')
                ...
                value: function events() {
                    ...
                    this.$searchInput
                        ...
                        .on('keyup', function (e) {
                            ...
                            if (
                                _this8.options.filterAcceptOnEnter &&
                                [13, 32].includes(e.which) &&
                                _this8.$searchInput.val()
                            ) {
                                if (_this8.options.single) {
                                    var $items = _this8.$selectItems
                                        .closest('li')
                                        .filter(':visible');
                                    if ($items.length) {
                                        _this8.setSelects([
                                            $items
                                                .first()
                                                .find('input['.concat(_this8.selectItemName, ']'))
                                                .val(),
                                        ]);
                                    }
                                } else {
                    ...
                    this.$selectItems.off('click').on('click', function (e) {
                        ...
                        var close = function close() {
                            if (
                                _this8.options.single &&
                                _this8.options.isOpen &&
                                !_this8.options.keepOpen
                            ) {
                                _this8.close();
                            }
                        };
            ...
            },
            {
                ...
                value: function updateSelected() {
                    for (var i = this.updateDataStart; i < this.updateDataEnd; i++) {
                        ...
                        this.$drop
                            .find('input[data-key='.concat(row._key, ']'))
            ...
            },
            {
                ...
                value: function getSelects() {
                    var type =
                        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'value';
                    var values = [];
